...
public class Bcryptpassword extends Password {
    ...
    public Bcryptpassword hashedValue(String hashedValue) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        Bcryptpassword bcryptpassword = (Bcryptpassword) o;
        return Objects.equals(this.hashedValue, bcryptpassword.hashedValue) &&
                super.equals(o);
    }

    @Override
    public int hashCode() {
        return Objects.hash(hashedValue, super.hashCode());
    }


    @Override
    public String toString() {
        String sb = "class Bcryptpassword {\n" +
