 ...
 */
@Schema(description = "Stores users and groups that have access to a tag.")


public class TagSharingSettings {
    @SerializedName("id")
    ...
    public TagSharingSettings permittedGroups(List<UserGroup> permittedGroups) {
        this.permittedGroups = permittedGroups;
        return this;
    }

    public TagSharingSettings addPermittedGroupsItem(UserGroup permittedGroupsItem) {
    ...
    public TagSharingSettings permittedUsers(List<User> permittedUsers) {
        this.permittedUsers = permittedUsers;
        return this;
    }

    public TagSharingSettings addPermittedUsersItem(User permittedUsersItem) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TagSharingSettings tagSharingSettings = (TagSharingSettings) o;
        return Objects.equals(this.id, tagSharingSettings.id) &&
                Objects.equals(this.permittedGroups, tagSharingSettings.permittedGroups) &&
                Objects.equals(this.permittedUsers, tagSharingSettings.permittedUsers) &&
                Objects.equals(this.$type, tagSharingSettings.$type);
    }
    ...
    public String toString() {
        ...
        String sb = "class TagSharingSettings {\n" +
